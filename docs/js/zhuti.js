document.addEventListener('DOMContentLoaded', function() {    
    ...
    // 资源路径（相对 docs/）
    const THEME_BG_IMAGE_DESKTOP = 'https://blog.yangjunyu.cc.cd/docs/image/zhuti.jpg';
    const THEME_BG_VIDEO_DESKTOP = '';
    const THEME_BG_IMAGE_MOBILE = 'https://blog.yangjunyu.cc.cd/docs/image/zhuti.jpg'; // 建议换更小体积的图片
